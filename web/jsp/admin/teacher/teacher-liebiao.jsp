    ...
    <div class="layui-body">
        <blockquote class="layui-elem-quote">
            ...
            <a class="layui-btn layui-btn-warm"
               href="${pageContext.request.contextPath}/teacher_saveUI.action">
                <i class="layui-icon layui-icon-add-1"></i>添加教师
            </a>
            ，或者以Excel形式
            <a class="layui-btn layui-btn"
               href="${pageContext.request.contextPath}/teacher_exportExcel.action">
                <i class="layui-icon layui-icon-list"></i>导出教师
            </a>
        </blockquote>
        <form action="${pageContext.request.contextPath}/teacher_findAll.action" id="teacherForm" name="teacherForm"
              method="post">
            <div class="layui-form">
                <table class="layui-table">
                    ...
                    <s:iterator value="list">
                        <tr>
                            <td><s:property value="tea_username"/></td>
                            <td><s:property value="tea_name"/></td>
                            <td><s:property value="tea_gender"/></td>
                            <td><s:property value="tea_address"/></td>
                            <td><s:property value="tea_age"/></td>
                            <td><s:property value="tea_mobile"/></td>
                            <td><s:property value="tea_email"/></td>
                            <td><s:property value="tea_qq"/></td>
                            <td>
                                <a class="layui-btn layui-btn-sm"
                                   href="${pageContext.request.contextPath}/teacher_delete.action?tea_id=<s:property value="tea_id"/>">
                                    <i class="layui-icon layui-icon-delete"></i>删除
                                </a>
                                <a class="layui-btn layui-btn-normal layui-btn-sm"
                                   href="${pageContext.request.contextPath}/teacher_edit.action?tea_id=<s:property value="tea_id"/>">
