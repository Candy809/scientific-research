    ...
    <div class="layui-body">
        <blockquote class="layui-elem-quote">
            ...
            <a class="layui-btn layui-btn-warm"
               href="${pageContext.request.contextPath}/student_saveUI.action">
                <i class="layui-icon layui-icon-add-1"></i>添加学生
            </a>
            ，或者以Excel形式
            <a class="layui-btn layui-btn"
               href="${pageContext.request.contextPath}/student_exportExcel.action">
                <i class="layui-icon layui-icon-list"></i>导出学生
            </a>
        </blockquote>
        <form action="${pageContext.request.contextPath}/student_findAll.action" id="fenyeForm" name="fenyeForm"
              method="post">
            <div class="layui-form">
                <table class="layui-table">
                    ...
                    <s:iterator value="list">
                        <tr>
                            <td><s:property value="stu_username"/></td>
                            <td><s:property value="stu_name"/></td>
                            <td><s:property value="stu_class"/></td>
                            <td><s:property value="stu_gender"/></td>
                            <td><s:property value="stu_address"/></td>
                            <td><s:property value="stu_age"/></td>
                            <td><s:property value="stu_mobile"/></td>
                            <td><s:property value="stu_email"/></td>
                            <td><s:property value="stu_qq"/></td>
                            <td>
                                <a class="layui-btn layui-btn-sm"
                                   href="${pageContext.request.contextPath}/student_delete.action?stu_id=<s:property value="stu_id"/>">
                                    <i class="layui-icon layui-icon-delete"></i>删除
                                </a>
                                <a class="layui-btn layui-btn-normal layui-btn-sm"
                                   href="${pageContext.request.contextPath}/student_edit.action?stu_id=<s:property value="stu_id"/>">
