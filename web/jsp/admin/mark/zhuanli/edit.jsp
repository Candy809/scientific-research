...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        ...
        <s:form namespace="/" cssClass="layui-form" action="mark_zl_edit" method="POST" enctype="multipart/form-data"
                theme="simple">
            ...
            <div class="layui-form-item">
                <label class="layui-form-label">国内专利</label>
                <div class="layui-input-block">
                    <s:textfield autocomplete="off" lay-verify="required" cssClass="layui-input"
                                 name="zl_mark_fanwei_guonei"
                                 value="%{model.zl_mark_fanwei_guonei}" required="true"/>
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">国际专利</label>
                <div class="layui-input-block">
                    <s:textfield autocomplete="off" lay-verify="required" cssClass="layui-input"
                                 name="zl_mark_fanwei_guoji"
                                 value="%{model.zl_mark_fanwei_guoji}" required="true"/>
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">专利申请</label>
                <div class="layui-input-block">
                    <s:textfield autocomplete="off" lay-verify="required" cssClass="layui-input"
                                 name="zl_mark_zhuangtai_shenqing"
                                 value="%{model.zl_mark_zhuangtai_shenqing}" required="true"/>
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">专利公开</label>
                <div class="layui-input-block">
                    <s:textfield autocomplete="off" lay-verify="required" cssClass="layui-input"
                                 name="zl_mark_zhuangtai_gongkai"
                                 value="%{model.zl_mark_zhuangtai_gongkai}" required="true"/>
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">专利授权</label>
                <div class="layui-input-block">
                    <s:textfield autocomplete="off" lay-verify="required" cssClass="layui-input"
                                 name="zl_mark_zhuangtai_shouquan"
                                 value="%{model.zl_mark_zhuangtai_shouquan}" required="true"/>
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">专利失效</label>
                <div class="layui-input-block">
                    <s:textfield autocomplete="off" lay-verify="required" cssClass="layui-input"
                                 name="zl_mark_zhuangtai_shixiao"
                                 value="%{model.zl_mark_zhuangtai_shixiao}" required="true"/>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <s:textfield autocomplete="off" lay-verify="required" cssClass="layui-input"
                                 name="zl_mark_shenhe_tongguo"
                                 value="%{model.zl_mark_shenhe_tongguo}" required="true"/>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <s:textfield autocomplete="off" lay-verify="required" cssClass="layui-input"
                                 name="zl_mark_shenhe_weitongguo"
                                 value="%{model.zl_mark_shenhe_weitongguo}" required="true"/>
                </div>
            </div>
