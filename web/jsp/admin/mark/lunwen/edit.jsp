...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        ...
        <s:form namespace="/" cssClass="layui-form" action="mark_lw_edit" method="POST"
            ...
            <div class="layui-form-item">
                <label class="layui-form-label">获得资金资助</label>
                <div class="layui-input-block">
                    <s:textfield autocomplete="off" lay-verify="required" cssClass="layui-input"
                                 name="lw_mark_zijinzizhu_zizhu"
                                 value="%{model.lw_mark_zijinzizhu_zizhu}" required="true"/>
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">未获得资金资助</label>
                <div class="layui-input-block">
                    <s:textfield autocomplete="off" lay-verify="required" cssClass="layui-input"
                                 name="lw_mark_zijinzizhu_weizizhu"
                                 value="%{model.lw_mark_zijinzizhu_weizizhu}" required="true"/>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <s:textfield autocomplete="off" lay-verify="required" cssClass="layui-input"
                                 name="lw_mark_shenhe_tongguo"
                                 value="%{model.lw_mark_shenhe_tongguo}" required="true"/>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <s:textfield autocomplete="off" lay-verify="required" cssClass="layui-input"
                                 name="lw_mark_shenhe_weitongguo"
                                 value="%{model.lw_mark_shenhe_weitongguo}" required="true"/>
                </div>
            </div>
