...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        ...
        <s:form namespace="/" cssClass="layui-form" action="xueshu_update" method="POST" enctype="multipart/form-data"
                theme="simple">
            <s:hidden name="xs_id" value="%{model.xs_id}"/>
            <s:hidden name="xs_defen" value="%{model.xs_defen}"/>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <s:textfield autocomplete="off" lay-verify="required" cssClass="layui-input" value="%{model.xs_canhuiren}" disabled="true"/>
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">会议名称</label>
                <div class="layui-input-block">
                    <s:textfield autocomplete="off" lay-verify="required" cssClass="layui-input" value="%{model.xs_huiyimingcheng}" disabled="true"/>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <s:textfield autocomplete="off" lay-verify="required" cssClass="layui-input" placeholder="请输入主办单位"
                                 name="xs_zhubandanwei" value="%{model.xs_zhubandanwei}" required="true"/>
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">会议类型</label>
                <div class="layui-input-block">
                    <s:radio list="#{'国际':'国际&nbsp&nbsp&nbsp&nbsp','国内':'国内'}" name="xs_huiyileixing" value="%{model.xs_huiyileixing}" required="true"/>
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">学科门类</label>
                <div class="layui-input-block">
                    <s:radio list="#{'社科类':'社科类&nbsp&nbsp&nbsp&nbsp','理工类':'理工类'}" name="xs_xuekemenlei" value="%{model.xs_xuekemenlei}" required="true"/>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <s:textfield autocomplete="off" lay-verify="required" cssClass="layui-input" placeholder="请输入参会地址"
                                 name="xs_canhuidizhi" value="%{model.xs_canhuidizhi}" required="true"/>
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">提交论文</label>
                <div class="layui-input-block">
                    <s:radio list="#{'是':'是&nbsp&nbsp&nbsp&nbsp;','否':'否'}" name="xs_tijiaolunwen" value="%{model.xs_tijiaolunwen}" required="true"/>
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">特邀报告</label>
                <div class="layui-input-block">
                    <s:radio list="#{'是':'是&nbsp&nbsp&nbsp&nbsp','否':'否'}" name="xs_teyaobaogao" value="%{model.xs_teyaobaogao}" required="true"/>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <s:textfield autocomplete="off" lay-verify="required" cssClass="layui-input" placeholder="请输入论文题目"
                                 name="xs_lunwentimu" value="%{model.xs_lunwentimu}" required="true"/>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <s:textfield autocomplete="off" lay-verify="required" cssClass="layui-input" placeholder="请输入报告题目"
                                 name="xs_baogaotimu" value="%{model.xs_baogaotimu}" required="true"/>
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">基金资助</label>
                <div class="layui-input-block">
                    <s:radio list="#{'是':'是&nbsp&nbsp&nbsp&nbsp','否':'否'}" name="xs_zijinzizhu" value="%{model.xs_zijinzizhu}" required="true"/>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <s:textfield autocomplete="off" lay-verify="required" cssClass="layui-input" placeholder="请输入资助金额"
                                 name="xs_zizhujine" value="%{model.xs_zizhujine}" required="true"/>
                </div>
            </div>
