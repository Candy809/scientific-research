    ...
    <div class="layui-body">
        <blockquote class="layui-elem-quote">
            ...
            <a class="layui-btn layui-btn-warm"
               href="${pageContext.request.contextPath}/xueshu_saveUI.action">
                <i class="layui-icon layui-icon-add-1"></i>添加学术交流信息
            </a>
            ，或者以Excel形式
            <a class="layui-btn layui-btn"
               href="${pageContext.request.contextPath}/xueshu_exportExcel.action">
                <i class="layui-icon layui-icon-list"></i>导出学术交流信息
            </a>
            。你还可以查看学术交流的
            <a class="layui-btn"
               href="${pageContext.request.contextPath}/xueshu_tubiaoUI.action">
                <i class="layui-icon layui-icon-chart-screen"></i>图表信息
            </a>
        </blockquote>

        <form action="${pageContext.request.contextPath}/xueshu_findAll.action" id="xueshuForm" name="xueshuForm"
              method="post">
            ...
            <div class="layui-form">
                <table class="layui-table">
                    ...
                    <s:iterator value="list">
                        <s:if test="#session.stu_id==stu_xueshu_id">
                            <tr>
                                ...
                                <td><s:property value="xs_defen"/></td>
                                <td>
                                    <a class="layui-btn layui-btn-sm"
                                       href="${pageContext.request.contextPath}/xueshu_delete.action?xs_id=<s:property value="xs_id"/>">
                                        <i class="layui-icon layui-icon-delete"></i>删除
                                    </a>
                                    <a class="layui-btn layui-btn-normal layui-btn-sm"
                                       href="${pageContext.request.contextPath}/xueshu_edit.action?xs_id=<s:property value="xs_id"/>">
