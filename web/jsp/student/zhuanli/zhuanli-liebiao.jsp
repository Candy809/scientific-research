    ...
    <div class="layui-body">
        <blockquote class="layui-elem-quote">
            ...
            <a class="layui-btn layui-btn-warm"
               href="${pageContext.request.contextPath}/zhuanli_saveUI.action">
                <i class="layui-icon layui-icon-add-1"></i>添加专利信息
            </a>
            ，或者以Excel形式
            ...
            。你还可以查看专利的
            <a class="layui-btn"
               href="${pageContext.request.contextPath}/zhuanli_tubiaoUI.action">
                <i class="layui-icon layui-icon-chart-screen"></i>图表信息
            </a>
        </blockquote>

        <form action="${pageContext.request.contextPath}/zhuanli_findAll.action" id="zhuanliForm" name="zhuanliForm"
              method="post">
            ...
            <div class="layui-form">
                <table class="layui-table">
                    ...
                    <s:iterator value="list">
                        <s:if test="#session.stu_id==stu_zhuanli_id">
                            <tr>
                                ...
                                <td><s:property value="zl_defen"/></td>
                                <td>

                                    <a class="layui-btn layui-btn-sm"
                                       href="${pageContext.request.contextPath}/zhuanli_delete.action?zl_id=<s:property value="zl_id"/>">
                                        <i class="layui-icon layui-icon-delete"></i>删除
                                    </a>
                                    <a class="layui-btn layui-btn-normal layui-btn-sm"
                                       href="${pageContext.request.contextPath}/zhuanli_edit.action?zl_id=<s:property value="zl_id"/>">
