    ...
    <div class="layui-body">
        <blockquote class="layui-elem-quote">
            ...
            <a class="layui-btn layui-btn-warm"
               href="${pageContext.request.contextPath}/keyan_saveUI.action">
                <i class="layui-icon layui-icon-add-1"></i>添加科研项目信息
            </a>
            ，或者以Excel形式
            <a class="layui-btn layui-btn"
               href="${pageContext.request.contextPath}/keyan_exportExcel.action">
                <i class="layui-icon layui-icon-list"></i>导出科研项目信息
            </a>
            。你还可以查看科研项目的
            <a class="layui-btn"
               href="${pageContext.request.contextPath}/keyan_tubiaoUI.action">
                <i class="layui-icon layui-icon-chart-screen"></i>图表信息
            </a>
        </blockquote>

        <form action="${pageContext.request.contextPath}/keyan_findAll.action" id="keyanForm" name="keyanForm"
              method="post">
            ...
            <div class="layui-form">
                <table class="layui-table">
                    ...
                    <s:iterator value="list">
                        <s:if test="#session.stu_id==stu_keyan_id">
                            <tr>
                                ...
                                <td><s:property value="ky_defen"/></td>
                                <td>
                                    <a class="layui-btn layui-btn-sm"
                                       href="${pageContext.request.contextPath}/keyan_delete.action?ky_id=<s:property value="ky_id"/>">
                                        <i class="layui-icon layui-icon-delete"></i>删除
                                    </a>
                                    <a class="layui-btn layui-btn-normal layui-btn-sm"
                                       href="${pageContext.request.contextPath}/keyan_edit.action?ky_id=<s:property value="ky_id"/>">
