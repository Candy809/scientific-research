...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        ...
        <s:form namespace="/" cssClass="layui-form" action="keyan_update" method="POST" enctype="multipart/form-data"
                theme="simple">
            <s:hidden name="ky_id" value="%{model.ky_id}"/>
            <s:hidden name="ky_defen" value="%{model.ky_defen}"/>
            <s:hidden name="ky_shenhe" value="%{model.ky_shenhe}"/>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <s:textfield autocomplete="off" lay-verify="required" cssClass="layui-input"
                                 value="%{model.ky_bianhao}" disabled="true"/>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <s:textfield autocomplete="off" lay-verify="required" cssClass="layui-input"
                                 value="%{model.ky_mingcheng}" disabled="true"/>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <s:textfield autocomplete="off" lay-verify="required" cssClass="layui-input" placeholder="请输入项目负责人"
                                 name="ky_fuzeren" value="%{model.ky_fuzeren}" required="true"/>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <s:textfield autocomplete="off" lay-verify="required" cssClass="layui-input" placeholder="请输入项目来源"
                                 name="ky_laiyuan" value="%{model.ky_laiyuan}" required="true"/>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <s:radio
                            ...
                            name="ky_leixing" value="%{model.ky_leixing}" required="true"/>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <s:radio
                            list="#{'国家级':'国家级&nbsp;&nbsp;&nbsp;&nbsp;','省厅级':'省厅级&nbsp;&nbsp;&nbsp;&nbsp;','校级':'校级&nbsp;&nbsp;&nbsp;&nbsp;'}"
                            name="ky_dengji" value="%{model.ky_dengji}" required="true"/>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <s:textfield autocomplete="off" lay-verify="required" cssClass="layui-input" placeholder="请输入项目总经费"
                                 name="ky_jingfei" value="%{model.ky_jingfei}" required="true"/>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <s:textfield autocomplete="off" lay-verify="required" cssClass="layui-input"
                                 ...
                                 name="ky_renwu" value="%{model.ky_renwu}" required="true"/>
                </div>
            </div>
